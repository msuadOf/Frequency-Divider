...
#
# Generated by export_simulation on Sun Oct 30 20:36:08 CST 2022
#
################################################################################
...
'-reset_run' switch to the './dds_compiler_2k.sh' script.

./dds_compiler_2k.sh -reset_run
...
./dds_compiler_2k.sh -noclean_files

For more information on the script, please type './dds_compiler_2k.sh -help'.
